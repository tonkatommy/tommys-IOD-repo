...
const BigCats = (props) => {
  ...
  const sortList = () => {
    ...
    const sortedList = [...currentCats].sort((a, b) => (a.name > b.name ? 1 : -1));
  ...
  const filterList = (filter) => {
    ...
    console.log(filter);
    const filteredList = [...currentCats].filter((cat) => cat.latinName.includes(filter));
  ...
  return (
    <>
      ...
      <button onClick={() => filterList("Panthera")}>Filter: Panthera</button>
